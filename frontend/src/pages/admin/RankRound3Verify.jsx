...
const RankRound3Verify = () => {
  ...
  const filteredMasters = masters.filter(m => {
    ...
    const buddyNo = m.studentId?.buddyNo || '';
    return (
      String(name).toLowerCase().includes(term) ||
      String(buddyNo).toLowerCase().includes(term)
    );
  });
...
export default RankRound3Verify;
