...
const RankRankStudentTable = () => {
  ...
  const filteredStudents = students.filter(s => {
    ...
    return (
      ...
      (s.buddyNo && String(s.buddyNo).toLowerCase().includes(term)) ||
      (s.regimentalNo && String(s.regimentalNo).toLowerCase().includes(term)) ||
  ...
  return (
    <div>
      <div className="action-bar" style={{ justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap' }}>
        <h2 style={{ margin: 0 }}>Cadet Record (Registration Data)</h2>
...
export default RankRankStudentTable;
